...
class LayerNormalizationAffineOperator: public Operator {
    public:
        LayerNormalizationAffineOperator(Tensor * a, Tensor * gamma, Tensor * beta, bool is_transient = false);
        ~LayerNormalizationAffineOperator() {}
};
