...
int main(int argc, char ** argv) {
   ...
   CUDAFullyStructualGraph * graph_structure;
    ...
    executor->set_csr(graph_structure->get_cuda_csrColInd(),graph_structure->get_cuda_csrValues(),
    graph_structure->get_cuda_csrRowOffsets(),graph_structure->get_num_global_vertices(),graph_structure->get_nnz());
