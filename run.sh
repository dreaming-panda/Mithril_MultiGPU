...
ibrun ./build/applications/async_multi_nodes/gcn --graph /work/03924/xuehaiq/maverick2/jingji/gnn_datasets/ogbn-arxiv --layers 2 --hunits 128 --epoch 1000 --lr 0.01 --decay 0 --part hybrid
