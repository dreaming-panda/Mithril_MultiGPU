...
do
    ibrun ./build/applications/async_multi_gpus/gcn --graph /work/03924/xuehaiq/maverick2/jingji/gnn_datasets/$dataset --layers 3 --hunits 128 --epoch 10000 --lr 0.001 --decay 0 --part hybrid | tee ./results/test_acc/async_multi_gpus/${dataset}_gcn.txt 
done
